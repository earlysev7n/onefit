  ...
  Future<void> _saveMealToFirestore(String mealType, Meal meal) async {
    ...
    for (int i = 0; i < meal.items.length; i++) {
      ...
      final foodItem = FoodItem(
        ...
        vitaminA: ing.vitaminA * scale,
        vitaminC: ing.vitaminC * scale,
        vitaminD: ing.vitaminD * scale,
        vitaminE: ing.vitaminE * scale,
        vitaminK: ing.vitaminK * scale,
        vitaminB6: ing.vitaminB6 * scale,
        vitaminB12: ing.vitaminB12 * scale,
        folate: ing.folate * scale,
        iron: ing.iron * scale,
        calcium: ing.calcium * scale,
        magnesium: ing.magnesium * scale,
        potassium: ing.potassium * scale,
        zinc: ing.zinc * scale,
        phosphorus: ing.phosphorus * scale,
        loggedAt: now,
        mealType: mealType,
        quantity: 1.0,
      );
